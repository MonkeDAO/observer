...
namespace Scraper
{
    ...
    public class NameScraper : ScraperBase
    {
        ...
        public NameScraper(IRpcClient client, ILogger logger, string name, string separator) : base(client, logger,
            name, separator)
        {
            _name = name;
            _sep = separator;
        ...
        public async Task Run()
        {
            ...
            var metadataAccounts = await GetMetadataAccounts(69, _name);
